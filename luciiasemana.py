...
def obtener_base_datos_y_tabla():
    base_datos = input("Introduce el nombre de la base de datos SQLite (.db): ")
    tabla = input("Introduce el nombre de la tabla en la base de datos: ")
...
if __name__ == "__main__":
    ...
    if archivo.endswith('.db'):
        base_datos, tabla = obtener_base_datos_y_tabla()
    else:
        base_datos = None
        tabla = None
    ...
    datos = mostrar_archivos(archivo,base_datos,tabla)
